...
class TEXT_IDS(Enum):
    ...
    CHESS_GAME_NAME_TEXT_ID = auto()
    CHESS_PVP_WAITING_TEXT_ID = auto()
    CHESS_PVP_CANCEL_TEXT_ID = auto()
    CHESS_PVP_TURN_TEXT_ID = auto()
    CHESS_PVP_CHECK_TEXT_ID = auto()
    CHESS_PVP_WIN_TEXT_ID = auto()
    CHESS_PVP_DRAW_TEXT_ID = auto()
    CHESS_PVP_RESIGN_TEXT_ID = auto()
    CHESS_PVP_RESIGNED_TEXT_ID = auto()
    CHESS_PVP_LAST_MOVE_TEXT_ID = auto()
    CHESS_PVP_CAPTURED_TEXT_ID = auto()
    CHESS_PVP_NOT_YOUR_TURN_TEXT_ID = auto()
    CHESS_PVP_NOT_IN_GAME_TEXT_ID = auto()
    CHESS_PVP_TIMEOUT_TEXT_ID = auto()
    CHESS_PLAY_AGAIN_TEXT_ID = auto()
    MINI_GAMES_YOU_ARE_TEXT_ID = auto()
    MINI_GAMES_OPPONENT_TEXT_ID = auto()
    MINI_GAMES_RATING_CHANGE_TEXT_ID = auto()
    MINI_GAMES_SETTINGS_TEXT_ID = auto()
    MINI_GAMES_SETTINGS_HEADER_TEXT_ID = auto()
    MINI_GAMES_INFO_TEXT_ID = auto()
    MINI_GAMES_INFO_BODY_TEXT_ID = auto()
    MINI_GAMES_ANONYMOUS_TEXT_ID = auto()
    MINI_GAMES_RANKED_TEXT_ID = auto()
    ...
    MINI_GAMES_RANKING_TEXT_ID = auto()
