...
class DbManager():
    ...
    def __query_execute(cls, cur: sqlite3.Cursor, query: str, args: tuple = None, error_str: str = "", is_many: bool = False):
        ...
        Args:
            cur (:class:`sqlite3.Cursor`): database cursor
            query (:class:`str`): query to execute. It may contain ? placehorders
            args (:class:`tuple`, optional): tuple of values that will replace the placeholders. Defaults to None.
            error_str (:class:`str`, optional): name of the method that caused the exception. Defaults to "".
            is_many (:class:`bool`, optional): whether to use the :func:`sqlite3.Cursor.executemany` function. Defaults to False.
        """
    ...
    def get_db(db_path: str = "data/DMI_DB.db") -> Tuple[sqlite3.Connection, sqlite3.Cursor]:
        ...
        Args:
            db_path (:class:`str`): path/name.

        Returns:
            :class:`Tuple[sqlite3.Connection, sqlite3.Cursor]`: sqlite database connection and cursor
        """
    ...
    def query_from_file(cls, filename: str = "data/DMI_DB.sql"):
        ...
        Args:
            filename (:class:`str`): path/name of the text file containing the queries
        """
    ...
    def query_from_string(cls, *queries: str):
        ...
        Args:
            queries (:class:`str`): tuple of queries
        """
        conn, cur = cls.get_db()
        for query in queries:
    ...
    @classmethod
    def select_from(cls, table_name: str, select: str = "*", where: str = "", where_args: tuple = None, order_by: str = "") -> list:
        ...
        Args:
            ...
            where (str, optional): where clause, with ? placeholders for the where_args. Defaults to "".
        ...
        cls.__query_execute(cur=cur, query=f"SELECT {select} FROM {table_name} {where} {order_by}", args=where_args, error_str="select_from")
    ...
    def delete_from(cls, table_name: str, where: str = "", where_args: tuple = None):
        ...
        Args:
            ...
            where (str, optional): where clause, with ? placeholders for the where args. Defaults to "".
            where_args (tuple, optional): args used in the where clause. Defaults to None.
        """
        conn, cur = cls.get_db()
